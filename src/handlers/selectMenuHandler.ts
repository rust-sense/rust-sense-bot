...
export default async (client: DiscordBot, interaction: any) => {
    ...
    if (interaction.customId === 'language') {
        ...
        await getPersistenceService().setGeneralSetting(guildId, 'language', interaction.values[0]);
        ...
        await getPersistenceService().setGeneralSetting(guildId, 'prefix', interaction.values[0]);
        ...
        await getPersistenceService().setGeneralSetting(guildId, 'trademark', interaction.values[0]);
        ...
        await getPersistenceService().setGeneralSetting(guildId, 'commandDelay', interaction.values[0]);
        ...
        await getPersistenceService().setGeneralSetting(guildId, 'voiceGender', interaction.values[0]);
        ...
        await getPersistenceService().setGeneralSetting(guildId, 'ttsProvider', interaction.values[0]);
        ...
        if (provider === 'piper') {
            ...
            await getPersistenceService().setGeneralSetting(guildId, 'piperVoice', interaction.values[0]);
        } else {
            instance.generalSettings.voiceGender = interaction.values[0];
            if (rustplus) rustplus.generalSettings.voiceGender = interaction.values[0];
            await getPersistenceService().setGeneralSetting(guildId, 'voiceGender', interaction.values[0]);
        ...
        await getPersistenceService().setGeneralSetting(guildId, 'teammateNameType', interaction.values[0]);
